...
* [GitHub 仓库](https://github.com/dcloudio/uni-app) ⭐ 41,618 | 🐛 706 | 🌐 JavaScript | 📅 2026-09-24
...
* [官方 Issues](https://github.com/dcloudio/uni-app/issues) ⭐ 41,618 | 🐛 706 | 🌐 JavaScript | 📅 2026-09-24
...
* ![vite] ![vue3] [create-uni](https://github.com/uni-helper/create-uni) ⭐ 311 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-21 ![stars](https://img.shields.io/github/stars/uni-helper/create-uni) 🛠️ 快速创建 uni-app 项目
* ![vite] ![vue3] [unh](https://github.com/uni-helper/unh) ⭐ 13 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-18 - 二次封装的启动命令，可以自定义hooks

## 模板

* [uni-preset-vue](https://github.com/dcloudio/uni-preset-vue) ⭐ 374 | 🐛 36 | 🌐 JavaScript | 📅 2026-09-18 ![stars](https://img.shields.io/github/stars/dcloudio/uni-preset-vue) - uni-app 官方模板。
...
* ![vue3] [vitesse-uni-app](https://github.com/uni-helper/vitesse-uni-app) ⭐ 578 | 🐛 9 | 🌐 TypeScript | 📅 2026-03-04 ![stars](https://img.shields.io/github/stars/uni-helper/vitesse-uni-app) - 由 uni-helper 支持的开始模板。
...
* ![vue3] [unibest](https://github.com/feige996/unibest) ⭐ 2,266 | 🐛 94 | 🌐 Vue | 📅 2026-09-15 ![stars](https://img.shields.io/github/stars/feige996/unibest) - uni-app 开发框架，内置大量基础功能，提供大量辅助功能。
* ![vue3] [wot-starter](https://github.com/wot-ui/wot-starter) ⭐ 387 | 🐛 26 | 🌐 Vue | 📅 2026-08-29 ![stars](https://img.shields.io/github/stars/wot-ui/wot-starter) - 飞一般开发体验的 uni-app 模板，基于 vitesse-uni-app 和 wot-ui 构建。
...
* [weapp-tailwindcss](https://github.com/sonofmagic/weapp-tailwindcss) ⭐ 1,863 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-25 - 面向小程序生态的 Tailwind CSS 适配方案。
* [unocss-applet](https://github.com/unocss-applet/unocss-applet) ⭐ 256 | 🐛 2 | 🌐 CSS | 📅 2026-09-10 ![stars](https://img.shields.io/github/stars/unocss-applet/unocss-applet) - 在小程序中使用 UnoCSS，兼容不支持的语法。
...
* [axios-adapter](https://github.com/uni-helper/axios-adapter) ⭐ 58 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-21 ![stars](https://img.shields.io/github/stars/uni-helper/axios-adapter) - 一个用于 uni-app 的 Axios 适配器。
...
* [uni-ui](https://github.com/dcloudio/uni-ui) ⭐ 2,091 | 🐛 107 | 🌐 JavaScript | 📅 2026-09-22 ![stars](https://img.shields.io/github/stars/dcloudio/uni-ui) - 基于 uni-app 的、全端兼容的、高性能 UI 框架。
...
* ![vue3] [uview-plus](https://github.com/ijry/uview-plus) ⭐ 719 | 🐛 47 | 🌐 JavaScript | 📅 2026-09-18 ![stars](https://img.shields.io/github/stars/ijry/uview-plus) - fork 自 uview 2.0，全面兼容 nvue 的 uni-app 生态框架，全面的组件和便捷的工具会让您信手拈来，如鱼得水。
* ![vue3] [uview-pro](https://github.com/anyup/uView-Pro) ⭐ 554 | 🐛 21 | 🌐 Vue | 📅 2026-09-20 ![stars](https://img.shields.io/github/stars/anyup/uView-Pro) - 为 Vue 3 + TypeScript 的 uni-app 生态量身打造的跨平台 UI 框架。
...
* ![vue3] [nutui-uniapp](https://github.com/nutui-uniapp/nutui-uniapp) ⭐ 559 | 🐛 40 | 🌐 Vue | 📅 2026-06-30 ![stars](https://img.shields.io/github/stars/nutui-uniapp/nutui-uniapp) - 京东风格的轻量级移动端组件库，基于 uniapp 与 Vue3，支持移动端 H5 和 小程序开发
...
* ![vue3] [wot-ui](https://github.com/wot-ui/wot-ui) ⭐ 381 | 🐛 56 | 🌐 TypeScript | 📅 2026-09-25 ![stars](https://img.shields.io/github/stars/wot-ui/wot-uni) - 一个轻量、美观、AI友好的 uni-app 组件库。
...
* [z-paging](https://github.com/SmileZXLee/uni-z-paging) ⭐ 1,474 | 🐛 72 | 🌐 JavaScript | 📅 2026-07-10 ![stars](https://img.shields.io/github/stars/SmileZXLee/uni-z-paging) - 一个 uni-app 的分页组件，全平台兼容，支持自定义下拉刷新、上拉加载更多，支持虚拟列表，支持自动管理空数据图、点击返回顶部，支持聊天分页、本地分页，支持展示最后更新时间，支持国际化等等
* ![vue3] [hy-app](https://github.com/MrGao-hy/hy-design-uni) ⭐ 459 | 🐛 1 | 🌐 Vue | 📅 2026-09-21 ![stars](https://img.shields.io/github/stars/MrGao-hy/hy-design-uni) - 📱一款使用 Vue3 + Ts 构建、面向 uni‑app 的跨端组件库。现已封装八十余款高质量业务组件，完整兼容小程序、H5、App‑plus 等多端环境；支持灵活的主题定制、样式变量覆盖，内置完善的国际化方案
* ![vue3] [uni-echarts](https://github.com/xiaohe0601/uni-echarts) ⭐ 182 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-09 ![stars](https://img.shields.io/github/stars/xiaohe0601/uni-echarts) - 适用于 uni-app 的 Apache ECharts 组件。

## 打包器插件

* ![vite] [vite-plugin-uni-pages](https://github.com/uni-helper/vite-plugin-uni-pages) ⭐ 207 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-16 ![stars](https://img.shields.io/github/stars/uni-helper/vite-plugin-uni-pages) - 在 uni-app 上使用基于文件的路由系统。
...
* [weapp-tailwindcss](https://github.com/sonofmagic/weapp-tailwindcss) ⭐ 1,863 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-25 ![stars](https://img.shields.io/github/stars/sonofmagic/weapp-tailwindcss) - 把 tailwindcss 原子化思想带入小程序开发吧 !
...
* ![vite] [vite-plugin-uni-layouts](https://github.com/uni-helper/vite-plugin-uni-layouts) ⭐ 68 | 🐛 22 | 🌐 TypeScript | 📅 2026-09-24 ![stars](https://img.shields.io/github/stars/uni-helper/vite-plugin-uni-layouts) - 为 Vite 下的 uni-app 提供类 nuxt 的 layouts 系统。
...
* ![vscode] [uni-create-view](https://github.com/uni-helper/uni-create-view) ⭐ 20 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-15 ![stars](https://img.shields.io/github/stars/uni-helper/uni-create-view) - 在 VSCode 中快速创建 uni-app 页面！
* ![vscode] [uni-helper-vscode](https://github.com/uni-helper/uni-helper-vscode) ⭐ 16 | 🐛 0 | 📅 2026-06-25 ![stars](https://img.shields.io/github/stars/uni-helper/uni-helper-vscode) - 增强 uni-app 系列产品在 VSCode 内的体验。
...
* ![vscode] [uni-app-schemas-vscode](https://github.com/uni-helper/uni-app-schemas-vscode) ⭐ 9 | 🐛 1 | 📅 2026-09-23 ![stars](https://img.shields.io/github/stars/uni-helper/uni-app-schemas-vscode) - 校验 uni-app 中 `androidPrivacy.json`、`pages.json` 和 `manifest.json` 格式。
* ![vscode] [uni-app-snippets-vscode](https://github.com/uni-helper/uni-app-snippets-vscode) ⭐ 8 | 🐛 1 | 📅 2026-09-23 ![stars](https://img.shields.io/github/stars/uni-helper/uni-app-snippets-vscode) - uni-app 基本能力代码片段。
...
* ![vscode] [uni-cloud-snippets-vscode](https://github.com/uni-helper/uni-cloud-snippets-vscode) ⭐ 1 | 🐛 1 | 📅 2026-09-21 ![stars](https://img.shields.io/github/stars/uni-helper/uni-cloud-snippets-vscode) - uni-cloud 基本能力代码片段。
...
* [skills](https://github.com/uni-helper/skills) ⭐ 105 | 🐛 1 | 🌐 TypeScript | 📅 2026-03-01 - uni-app skills
